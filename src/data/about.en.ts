...
export const data: Data = {
  ...
  experience: [
    {
      ...
      endDate: "",
      projects: {
        tags: ["Golang", "NextJS", "ScyllaDB", "k9s", "ArgoCD", "Kafka", "Spark", "Trino", "Iceberg", "Parquet", "Scrum", "Claude Code", "AI"],
        job: "Big Data Group / Backend Team → xfunction Team",
        jobDescription:
          "Working as a backend engineer in the Big Data Group, initially in the backend team, then moved to the xfunction team. Developing and maintaining systems using Golang, NextJS, ScyllaDB, k9s, ArgoCD, Kafka, and Spark for e-commerce platform infrastructure. Working in a Scrum development environment. Played a central role as a founding member of the xfunction team. Previously, communication between FE and BE teams and coordination with other departments was fragmented, resulting in significant delays — for example, a project scheduled for June release was delayed until October due to communication losses. For the new team, prioritized psychological safety by conducting Drucker-style exercises, fostering proactive communication among team members, and aligning expectations with PdM and stakeholders. As a result, eliminated unintended project delays to zero within 5 months of the team's establishment. Actively communicated with designers and across departments/teams, serving as a lead within the xfunction team. Built the data platform on Iceberg (Parquet storage) with Trino as the analytics query engine; introduced Spark SQL's `CREATE OR REPLACE TABLE` syntax in the data ingestion process, improving processing speed and cost by 30%. Drove AI adoption by optimizing Claude Code's Agents (subagents) and harness — designed and rolled out a subagent setup that routes tasks to Opus, Sonnet, or Haiku by workload, cutting token usage cost by 50%.",
        experience: ["Big data infrastructure", "Event-driven architecture with Kafka", "Kubernetes orchestration", "CI/CD with ArgoCD", "Scrum development", "Spark optimization (CREATE OR REPLACE TABLE: 30% faster and cheaper processing)", "AI adoption (Claude Code Agents & harness optimization)", "Model routing subagents (Opus / Sonnet / Haiku by workload)", "50% token cost reduction", "Team launch (founding member, central role)", "Elimination of communication-driven delays", "Scrum event facilitation", "Psychological safety initiatives", "Drucker-style exercises", "PdM/stakeholder expectation alignment", "Remote knowledge sharing", "Cross-functional communication", "Leadership"],
        team: 0,
      },
    },
    {
      ...
      endDate: "2025-06-30",
      projects: {
        tags: ["Golang", "AWS", "Serverless", "Lambda", "CloudFront", "Data Analytics", "Devin", "Terraform", "IaC", "Redis", "RDS", "PayloadCMS", "SSTv3", "NextJS", "REST API", "Microservices", "Athena", "Glue", "Quick Suite", "Parquet"],
        ...
        experience: ["High-traffic system architecture", "Microservices architecture", "Data analytics platform (Parquet/Athena/Glue/Quick Suite)", "Cost optimization with serverless (30% reduction)", "AI integration leadership", "IaC for AI-friendly infrastructure", "AWS Savings Plans optimization", "Redis for performance optimization", "Customer-facing technical leadership", "Image processing and coordinate mapping", "2-week infrastructure setup and release", "Onsite Vietnam collaboration", "English team management", "Rapid full-stack development"],
        team: 16,
      },
    },
    {
  ...
  selfProject: [
    {
      title: "BikeHub",
      desc: `A mobile app for logging motorcycle fuel efficiency and reading bike news. After building and running its Java/JSP predecessor "バイク燃費.com" solo, rebuilt it as a successor with a Django (DRF) backend API and a React Native (Expo) client, and shipped it on both the App Store and Google Play. The service has since ended.`,
      link: "",
      tags: [
        "Python(Django)",
        "DRF",
    ...
    {
      title: "SAVE EAT",
      desc: `A support site for restaurants during the COVID-19 pandemic — built and launched within one week and operated with Docker Compose. The service has since ended.`,
      link: "",
