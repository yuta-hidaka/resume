  ...
  experience: [
    {
      ...
      projects: {
        ...
        jobDescription:
          "Working as a backend engineer in the Big Data Group, initially in the backend team, then moved to the xfunction team. Developing and maintaining systems using Golang, NextJS, ScyllaDB, k9s, ArgoCD, Kafka, and Spark for e-commerce platform infrastructure. Working in a Scrum development environment. Involved in the launch of the xfunction team and facilitated Scrum events. Promoted psychological safety through remote knowledge sharing sessions and Drucker-style exercises. Actively communicated with designers and across departments/teams, serving as a lead within the xfunction team.",
        experience: ["Big data infrastructure", "Event-driven architecture with Kafka", "Kubernetes orchestration", "CI/CD with ArgoCD", "Scrum development", "Team launch", "Scrum event facilitation", "Psychological safety initiatives", "Remote knowledge sharing", "Cross-functional communication", "Leadership"],
        team: 0,
      },
    },
    {
