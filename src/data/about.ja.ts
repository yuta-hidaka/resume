  ...
  experience: [
    {
      ...
      projects: {
        ...
        experience: ["ビッグデータインフラ", "Kafkaによるイベント駆動アーキテクチャ", "Kubernetesオーケストレーション", "ArgoCDによるCI/CD", "スクラム開発", "チーム立ち上げ（初期メンバー・中心的役割）", "コミュニケーションロスによる遅延の解消", "スクラムイベント運営", "心理的安全性向上施策", "ドラッカー風エクササイズ", "PdM・ステークホルダーとの期待値調整", "リモートナレッジシェア", "クロスファンクショナルコミュニケーション", "リーダーシップ"],
        team: 0,
      },
    },
    {
