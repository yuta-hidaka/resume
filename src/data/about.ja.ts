  ...
  experience: [
    {
      ...
      projects: {
        ...
        experience: ["ビッグデータインフラ", "Kafkaによるイベント駆動アーキテクチャ", "Kubernetesオーケストレーション", "ArgoCDによるCI/CD", "スクラム開発", "Spark最適化（CREATE OR REPLACE TABLE導入で処理速度・コスト30%改善）", "チーム立ち上げ（初期メンバー・中心的役割）", "コミュニケーションロスによる遅延の解消", "スクラムイベント運営", "心理的安全性向上施策", "ドラッカー風エクササイズ", "PdM・ステークホルダーとの期待値調整", "リモートナレッジシェア", "クロスファンクショナルコミュニケーション", "リーダーシップ"],
        team: 0,
      },
    },
    {
