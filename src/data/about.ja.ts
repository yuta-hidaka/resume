  ...
  experience: [
    {
      ...
      projects: {
        ...
        job: "ビッグデータグループ / バックエンドチーム → xfunctionチーム",
        jobDescription:
    ...
    },
    {
      ...
      projects: {
        ...
        job: "受託開発",
        jobDescription:
          "ふるさと納税のポイントを株式に交換できる権利を付与するサービスの開発。最大1000RPSを超えるアクセスを想定し、高トラフィック前提で設計・開発。",
        experience: [""],
        team: 30,
      },
    },
    {
      ...
      projects: {
        ...
        job: "受託開発",
        jobDescription:
          "開発3名・QA3名のチームでテックリードを担当。月額25万円ほどのインフラ費用がかかっていたシステムを、LambdaとCloudFrontを用いた月額1万円規模のシステムへ移行する提案を実施。プリセールス時点で月額150万円と見積もられていた運用費用も含め、大幅なコスト圧縮を実現。属人化を避けるため移行作業から手作業を排し、IaCの導入とともにすべてGolangで記述。フロントエンドはSEOと表示速度を考慮し、Astro JSでISRライクな構成を設計。通常はFE・BE・インフラと単一役割でアサインされるところ、全工程を担えるフルスタックエンジニアとしての経験を評価され本PJにアサインされた。",
        experience: [""],
        team: 7,
      },
    },
    {
      ...
      projects: {
        ...
        job: "受託開発",
        jobDescription:
          "企業サイトの更新。海外チームと協働し、フルスタックエンジニアとしてバックエンド・フロントエンド・インフラを担当。バングラデシュチームと時差のある中で非同期に開発を進め、必要に応じてミーティングや仕様説明を実施。",
        experience: [""],
        team: 20,
      },
    },
