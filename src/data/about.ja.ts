  ...
  experience: [
    {
      ...
      projects: {
        ...
        jobDescription:
          "ECプラットフォームのビックデータグループでバックエンドエンジニアとして従事。最初はバックエンドチームに所属し、その後xfunctionチームに異動。Golang、NextJS、ScyllaDB、k9s、ArgoCD、Kafka、Sparkなどを利用してシステムの開発・保守を担当。スクラム開発で開発を進めている。xfunctionチームの立ち上げに関与し、スクラムイベントの運営を担当。心理的安全性向上のため、リモートワークでのナレッジシェアやドラッカー風エクササイズを実施。デザイナー、他部署、他チーム間で積極的にコミュニケーションを取り、xfunction内のリードとして活動。",
        experience: ["ビッグデータインフラ", "Kafkaによるイベント駆動アーキテクチャ", "Kubernetesオーケストレーション", "ArgoCDによるCI/CD", "スクラム開発", "チーム立ち上げ", "スクラムイベント運営", "心理的安全性向上施策", "リモートナレッジシェア", "クロスファンクショナルコミュニケーション", "リーダーシップ"],
        team: 0,
      },
    },
    {
